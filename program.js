...
program
    ...
    .option("-H, --headers <headers...>", "'Cache-Control: no-cache'", ["Cache-Control: no-cache"])
    ...
    .option("--reqPlugin <plugin>", "the file path to a .js that exports a requestTransform function")
